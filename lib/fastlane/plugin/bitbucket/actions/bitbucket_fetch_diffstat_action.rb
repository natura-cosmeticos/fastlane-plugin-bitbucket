...
module Fastlane
  module Actions
    class BitbucketFetchDiffstatAction < Action
      def self.run(params)
        ...
        Helper::BitbucketHelper.fetch_diffstat(auth_header, base_url, params[:project_key], params[:repo_slug], params[:request_id], params[:source_commit], params[:destination_commit])
      end

      def self.description
        "This action allows fastlane to fetch BitBucket Pull Requests diffstat."
      end
